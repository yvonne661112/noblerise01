...
| 檔案 | 用途 | 狀態 |
|------|------|------|
| [INDEX.md](./INDEX.md) | 本文件：目錄索引、進度總覽、注意事項 | 持續更新 |
| [task01.md](./task01.md) | WordPress → Astro 遷移任務紀錄 | ✅ 完成 |
| [task02.md](./task02.md) | DNS 切換與正式上線計畫、SEO 保護機制 | ⏳ 待執行 |
| [TODO.md](./TODO.md) | 第二輪改善項目清單（SEO、設計、程式碼） | ✅ 全部完成 |
| [Process.md](./Process.md) | 第二輪 TODO 執行批次紀錄（中斷重啟依據） | ✅ 全部完成 |
...
| 階段 | 內容 | 狀態 |
|------|------|------|
| task01 | WordPress → Astro 完整遷移 | ✅ 完成 |
| 第一輪 TODO | 高／中／低優先度改善（SEO、設計、元件重構） | ✅ 完成 |
| 第二輪 TODO Batch 1 | 遷移連貫性（M-1~M-4、A-3） | ✅ 完成 |
| 第二輪 TODO Batch 2 | SEO 改善（A-1/C-6、A-2/C-2、A-4、A-5） | ✅ 完成 |
| 第二輪 TODO Batch 3 | 設計改善（B-1~B-4） | ✅ 完成 |
| 第二輪 TODO Batch 4 | 程式碼低效（C-1、C-3、C-4、C-5） | ✅ 完成 |
